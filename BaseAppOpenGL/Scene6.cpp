...
CScene6::CScene6()
{
	...
	pTextures->CreateTextureMipMap(1, "../Scene1/cm_upBLUR.bmp");
	pTextures->CreateTextureTGA(2, "../Scene6/Tree.tga");
}
...
int CScene6::DrawGLScene(void)	// Função que desenha a cena
{
	...
	// Desenhar todos os objetos OPACOS (sem transparência) 
	// DESTINATION (D)
	...
	// Desenhar todos os objetos TRANSPARENTES (com transparência) 
	// SOURCE (S)
	...
	glTexCoord2f(1.0f, 1.0f); glVertex3f(5.0f, 20.0f, 0.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-5.0f, 20.0f, 0.0f);
	glEnd();
	glPopMatrix();
	...
	glTexCoord2d(1.0f, 0.0f); glVertex3f(50.0f, 0.0f, 50.0f);
	glTexCoord2d(1.0f, 1.0f); glVertex3f(50.0f, 0.0f, -50.0f);
	glTexCoord2d(0.0f, 1.0f); glVertex3f(-50.0f, 0.0f, -50.0f);
	glEnd();
	glPopMatrix();
